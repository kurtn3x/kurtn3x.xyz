...
function f(o, t, e) {
  let s = ['altKey', 'ctrlKey', 'metaKey', 'shiftKey'],
    n = ['pageX', 'pageY', 'clientX', 'clientY', 'screenX', 'screenY', 'offsetX', 'offsetY'],
    i = new Event(o, { bubbles: !0, cancelable: !0 }),
    h = t.touches[0];
  return (i.button = 0), (i.which = i.buttons = 1), _(i, t, s), _(i, h, n), T(i, e), i;
}
function T(o, t) {
  let e = t.getBoundingClientRect();
  o.offsetX === void 0 && ((o.offsetX = o.clientX - e.x), (o.offsetY = o.clientY - e.y)),
    o.layerX === void 0 && ((o.layerX = o.pageX - e.left), (o.layerY = o.pageY - e.top));
}
function d(o, t) {
  if ((D(t), o instanceof HTMLCanvasElement)) {
    let e = t;
    (e.width = o.width), (e.height = o.height), e.getContext('2d').drawImage(o, 0, 0);
  }
  y(o, t), (t.style.pointerEvents = 'none');
  for (let e = 0; e < o.children.length; e++) d(o.children[e], t.children[e]);
}
function y(o, t) {
  let e = getComputedStyle(o);
  for (let s of e) s.includes('transition') || (t.style[s] = e[s]);
  Object.keys(t.dataset).forEach((s) => delete t.dataset[s]);
}
function D(o) {
...
var r = class {
  ...
  getData(t) {
    let e = t.toLowerCase(),
      s = this._data[e];
    return e === 'text' && s == null && (s = this._data['text/plain']), s;
  }
  setData(t, e) {
    this._data[t.toLowerCase()] = e;
  }
  setDragImage(t, e, s) {
    this._dragDropTouch.setDragImage(t, e, s);
  }
};
var { round: m } = Math,
  b = {
  ...
  c = class {
    ...
    configuration;
    constructor(t = document, e = document, s) {
      for (
        this.configuration = { ...b, ...(s || {}) }, this._dragRoot = t, this._dropRoot = e;
    ...
    setDragImage(t, e, s) {
      (this._imgCustom = t), (this._imgOffset = { x: e, y: s });
    }
    _touchstart(t) {
    ...
    _touchmove(t) {
      ...
      if (this._shouldHandleMove(t) || this._shouldHandlePressHoldMove(t)) {
        ...
        if (
          ...
          let s = this._getHotRegionDelta(t);
          globalThis.scrollBy(s.x, s.y);
        }
      }
    }
    _touchend(t) {
    ...
    _shouldStartDragging(t) {
      ...
      return (
        ...
        (this.configuration.isPressHoldMode && e >= this.configuration.pressHoldThresholdPixels)
      );
    }
    _reset() {
      this._destroyImage(),
    ...
    _getDelta(t) {
      ...
      let { x: e, y: s } = this._ptDown,
        n = a(t);
      return ((n.x - e) ** 2 + (n.y - s) ** 2) ** 0.5;
    }
    _getHotRegionDelta(t) {
      let { clientX: e, clientY: s } = t.touches[0],
    ...
    _getTarget(t) {
      let e = a(t),
        s = this._dropRoot.elementFromPoint(e.x, e.y);
      for (; s && getComputedStyle(s).pointerEvents == 'none'; ) s = s.parentElement;
      return s;
    }
    _createImage(t) {
      ...
      requestAnimationFrame(() => {
        if (this._img) {
          ...
          (s.position = 'absolute'),
            ...
            (s.zIndex = '999999'),
            (s.left = `${m(e.x - this._imgOffset.x)}px`),
            (s.top = `${m(e.y - this._imgOffset.y)}px`);
        }
      });
    }
    _dispatchEvent(t, e, s) {
      if (!(t && s)) return !1;
      let n = f(e, t, s);
      return (n.dataTransfer = this._dataTransfer), s.dispatchEvent(n), n.defaultPrevented;
    }
    _closestDraggable(t) {
      for (let e = t; e !== null; e = e.parentElement)
        if (e.getAttribute('draggable') || e.draggable) return e;
      return null;
    }
  };
function p(o = document, t = document, e) {
  new c(o, t, e);
}
import.meta.url.includes('?autoload')
  ? p(document, document, { forceListen: !0 })
  : (globalThis.DragDropTouch = {
      enable: function (o = document, t = document, e) {
        p(o, t, e);
      },
    });
